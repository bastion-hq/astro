...
A simple JSON API server for testing Astro functionality. This server provides basic CRUD operations and can be extended as needed for testing different scenarios.
...
Create a test file in `__astro__/` directory:

```typescript
import { GET, POST, ApiCheckBuilder, JSON, START, END, Frequency } from "../astro-test-system/src/index";
